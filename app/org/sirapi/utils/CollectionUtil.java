...
public class CollectionUtil {
    ...
    public void initConfigCache() {
        configCache = new HashMap<String, String>();
        configCache.put("sirapi.repository.triplestore", ConfigFactory.load().getString("sirapi.repository.triplestore"));
    }
    ...
    public static String getCollectionPath(Collection collection) {
        ...
        switch (collection) {
            ...
            case SPARQL_UPDATE:
            case SPARQL_GRAPH :
                collectionName = getConfigCache().get("sirapi.repository.triplestore") + getCollectionName(collection.get());
                break;
        }
