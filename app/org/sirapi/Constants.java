...
public class Constants {
    ...
    public static final String TEST_RESPONSE_OPTION3_URI = SIR_KB + "TestResponseOption3";
    public static final String TEST_RESPONSE_OPTION4_URI = SIR_KB + "TestResponseOption4";
