...
public class Constants {
    ...
    public static final String TEST_DETECTOR_SLOT1_URI = TEST_INSTRUMENT_URI + "/ATT/1";
    public static final String TEST_DETECTOR_SLOT2_URI = TEST_INSTRUMENT_URI + "/ATT/2";
    ...
    public static final String TEST_RESPONSE_OPTION_SLOT1_URI = TEST_CODEBOOK_URI + "/ROS/1";
    public static final String TEST_RESPONSE_OPTION_SLOT2_URI = TEST_CODEBOOK_URI + "/ROS/2";
