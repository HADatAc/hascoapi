...
public class STR extends HADatAcThing implements Comparable<STR> {
    private static final String className = "hasco:STR";
    ...
    */
    ...
    public static STR find(String uri) {
		...
		if (hascoTypeUri.equals(HASCO.STR)) {
			str = new STR();
		} else {
			return null;
		}
    ...
    public static List<STR> findByOwner(String ownerUri) {
        /* 
        SolrQuery query = new SolrQuery();
        query.set("q", "owner_uri_str:\"" + ownerUri + "\"");
        query.set("sort", "started_at_date asc");
    ...
    public static List<STR> findByQuery(String query) {
