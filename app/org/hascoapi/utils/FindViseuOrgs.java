...
public class FindViseuOrgs {
    public static void main(String[] args) {
        if (args.length != 1) {
            System.err.println("Usage: java FindViseuOrgs <KGR-FACULDADES-URI.xlsx>");
            System.exit(1);
        }
        ...
        try (FileInputStream fis = new FileInputStream(args[0]);
            ...
            System.out.println("Searching for VISEU and PIAGET organizations...\n");
            ...
            for (int i = 1; i <= orgSheet.getLastRowNum(); i++) {
                ...
                if (labelCell != null) {
                    ...
                    if (upperLabel.contains("VISEU") || upperLabel.contains("PIAGET")) {
