...
// import org.hascoapi.ingestion.opcua.OpcUaWorker;
...
//         List<OpcUaObject> activeObjects = OpcUaWorker.getInstance().listActiveObjects();
...
//             return ok(ApiUtil.createResponse("Invalid objectUri", false));
//         }
//         return ok(ApiUtil.createResponse(OpcUaWorker.getInstance().getMonitor().getLatestValue(objectUri), true));
//     }
