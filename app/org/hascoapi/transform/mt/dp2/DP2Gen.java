...
public class DP2Gen {
    ...
    public static String genByStatus(String status, String filename, String mediaFolder, String verifyUri) {
        ...
        if (deployments != null) {
            for (Deployment deployment: deployments) {
                ...
                //helper = INSSlotElement.addByInstrument(helper,deployment);
            }
        }
    ...
    public static String genByDeployments(Instrument instrument, String filename, String mediaFolder, String verifyUri) {
        if (instrument == null) {
            return "";
        }
    ...
    public static String genByPlatforms(Instrument instrument, String filename, String mediaFolder, String verifyUri) {
        if (instrument == null) {
            return "";
        }
        INSGenHelper helper = new INSGenHelper();
