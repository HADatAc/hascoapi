...
public class Responses {
    ...
    public static final String RESPONSE_NOK_RESET_DETECTOR_SLOTS            
        = "{\"isSuccessful\":false,\"body\":\"Test instrument <http://hadatac.org/kb/test/TestInstrument> needs to exist before its detectorSlots can be deleted.\"}";
    ...
    public static final String RESPONSE_NOK_RESET_RESPONSE_OPTION_SLOTS     
        = "{\"isSuccessful\":false,\"body\":\"Test codebook <http://hadatac.org/kb/test/TestCodebook> needs to exist before its responseoption slots can be deleted.\"}";
    ...
    public static final String RESPONSE_OK_CREATE_DETECTOr_SLOTS 
        = "{\"isSuccessful\":true,\"body\":\"A total of 2 detectorSlots have been created for instrument <http://hadatac.org/kb/test/TestInstrument>.\"}";
    ...
    public static final String RESPONSE_OK_DELETE_DETECTOR_SLOTS 
        = "{\"isSuccessful\":true,\"body\":\"DetectorSlots for Instrument <http://hadatac.org/kb/test/TestInstrument> have been deleted.\"}";
