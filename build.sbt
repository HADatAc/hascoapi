...
libraryDependencies ++= Seq(
  ...
  "org.apache.commons" % "commons-lang3" % "3.19.0",  // StringUtils, etc.
  ...
  // Needed by Guice AOP (MethodInterceptor)
  "aopalliance" % "aopalliance" % "1.0"
).map(_.exclude("*", "slf4j-log4j12")) ++ guiceDeps
